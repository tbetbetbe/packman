...
* In addition, you must run the [googleapis-packman][9] tests,
  which depend upon this library. Clone a copy of the
  [googleapis-packman][9] repo, update the dependency to point to
  your local copy of the googleapis-packman repo, and ensure that the
...
[9]: https://github.com/googleapis/googleapis-packman
